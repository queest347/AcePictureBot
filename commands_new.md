...
------- | ----------- | ----------
WaifuRegister<br>HusbandoRegister | Register your Waifu or Husbando and take them to Discord and Twitch chat!<br>Read this for tips:<ul><li>You will need to follow @AcePictureBot to register.</li><li>Use their full name. You can use the [Waifu](https://github.com/ace3df/AcePictureBot/blob/master/lists/Waifu%20List.txt) - [Husbando](https://github.com/ace3df/AcePictureBot/blob/master/lists/Husbando%20List.txt) list to help you find the correct name.</li><li>Seasonal waifus are a bad idea as not much art is out there.</li><li>If the bot suggest to add $ on the end of the name - add it on.</li><li>Don't add stuff like "! . , ( ) [ ]" unless it's needed in the name (or series). </li><li>Don't register a real person, series name, twitter handle, image tag(s) or a pony.</li></ul>| ❌ WaifuRegister Tojo Nozomi<br> ✔️ WaifuRegister Toujou Nozomi<br> ❌ WaifuRegister Akame <br>✔️ WaifuRegister Akame (Akame Ga Kill!)<br> ❌ WaifuRegister Ryūko Matoi<br> ✔️ WaifuRegister Ryuuko Matoi <br>
...
Idol|Get a random Idol!<br>**Optional:**<br>You can get a male idol by adding "Male" to your tweet!<br>Add one of these series to get a idol from that spersific series:<br><ul><li>Love Live!</li><li>Idolmaster</li><li>Idolmaster Cinderalla Girls</li><li>AKB0048</li><li>Wake up Girls</li><li>Aikatsu</li></ul>You can also add "OTP" on the end for these shows:<br><ul><li>Love Live!</li></ul>|Idol<br>Idol Male<br>Idol Love Live<br>Idol Cinderalla<br>Idol Love Live OTP
